...
int main (void) {
   ...
   /* Testing Memory (DDR2_SDRAM_16Mx32)*/
   {
      ...
      status = Xil_TestMem32((u32*)XPAR_DDR2_SDRAM_16MX32_MEM_BASEADDR, 1024, 0xAAAA5555, XIL_TESTMEM_ALLMEMTESTS);
      if (status == 0) {
         print("PASSED!\r\n");
      }
      else {
      ...
      status = Xil_TestMem16((u16*)XPAR_DDR2_SDRAM_16MX32_MEM_BASEADDR, 2048, 0xAA55, XIL_TESTMEM_ALLMEMTESTS);
      if (status == 0) {
         print("PASSED!\r\n");
      }
      else {
      ...
      status = Xil_TestMem8((u8*)XPAR_DDR2_SDRAM_16MX32_MEM_BASEADDR, 4096, 0xA5, XIL_TESTMEM_ALLMEMTESTS);
      if (status == 0) {
         print("PASSED!\r\n");
      }
      else {
